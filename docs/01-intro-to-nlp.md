...
texts = \["I love this movie", "This film was terrible", "Amazing acting", "Worst movie ever"]
...
X = vectorizer.fit\_transform(texts)
...
\- \*\*LSTM (Long Short-Term Memory)\*\* – RNN variant that handles long-term dependencies, solves vanishing gradient issue

\- \*\*GRU (Gated Recurrent Unit) / CNN\*\* – GRU is a simplified LSTM; CNNs used for capturing local patterns (n-grams) in text

\- \*\*Transformers\*\* – Attention-based architecture, processes sequences in parallel (basis of BERT, GPT, etc.)
...
&#x20;   Embedding(input\_dim=5000, output\_dim=64, input\_length=100),
...
\- \*\*Multilingualism\*\* – Handling multiple languages, dialects, code-switching
